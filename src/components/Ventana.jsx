...
//       email,
//       password,
//       "./public/avatar.jpg", // Usar ruta relativa para GitHub Pages
//       true
//     );
...
//   return (
//     <div className="flex items-center justify-center fixed inset-0 h-screen w-full bg-gradient-to-r from-neutral-800 to-slate-900 z-50">
//       {showForgotPassword ? (
//         <div className="bg-gray-800 p-8 rounded-lg shadow-2xl w-96 flex flex-col relative">
